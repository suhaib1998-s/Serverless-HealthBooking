...
export default {
  ...
  methods: {
    fetchAppointments() {
      fetch("https://35v7jaeyu3.execute-api.us-east-1.amazonaws.com/prod/appointments")
        .then(res => res.json())
        .then(data => {
    ...
    updateStatus(appointment, newStatus) {
      ...
      const url = `https://35v7jaeyu3.execute-api.us-east-1.amazonaws.com/prod/appointments/${appointment.appointmentId}`;
